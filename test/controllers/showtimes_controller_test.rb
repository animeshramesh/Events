...
class ShowtimesControllerTest < ActionController::TestCase
  ...
  test "should create showtime" do
    assert_difference('Showtime.count') do
      post :create, showtime: { cost: @showtime.cost, date: @showtime.date, eventID: @showtime.eventID, locID: @showtime.locID, time: @showtime.time }
    end
  ...
  test "should update showtime" do
    patch :update, id: @showtime, showtime: { cost: @showtime.cost, date: @showtime.date, eventID: @showtime.eventID, locID: @showtime.locID, time: @showtime.time }
    assert_redirected_to showtime_path(assigns(:showtime))
  end
